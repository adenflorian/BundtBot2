[√] The client should now begin sending OP 1 Heartbeat payloads every heartbeat_interval milliseconds, until the connection is eventually closed or terminated.
